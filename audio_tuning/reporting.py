...
def write_report(
    ...
    with (out / "report.md").open("w", encoding="utf-8") as file:
        ...
        file.write("- Практический вывод: одиночная позиция используется только для диагностики.\n\n")
        ...
        file.write(
            "DSP-рекомендация отключена: сначала соберите все шесть фиксированных "
